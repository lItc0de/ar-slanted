...
<Layout location={props.location} flex>

# Info

This website is an add-on to slanted magazine's #37 AI print issue – an experimental AR-based video player to showcase supplementary digital content. The marker symbols (▹) in the magazine indicate links to the AR app: To view an associated video, first select the magazine chapter on the home page and then point the camera of your mobile device at the marked page.

Currently, the AR functionality only works on mobile devices with a Chrome browser (sorry!). In all other cases, you can explore the videos through a good old-fashioned scroll website (yay!).

# Imprint

Slanted Publishers UG<br />
(haftungsbeschränkt)<br />
Nebeniusstrasse 10<br />
76137 Karlsruhe<br />
Germany<br />
[www.slanted.de](https://www.slanted.de/en/)

Responsible tax office: Karlsruhe City<br />
Sales tax Identification/USt.Id.: DE295329244<br />
Administration: Lars Harmsen, Julia Kahl<br />
Responsible court of law: Local district court Mannheim<br />
Commercial Register: HRB 719864<br />
Responsible in form and content in accordance with § 5 TMG are Lars Harmsen and Julia Kahl, contact details above.

Webdesign: [Kolja Buscher](http://www.koljabuscher.de/)<br />
Implementation: [Dennis Mußgnug, Marco Umfahrer](http://freelancer-karlsruhe.de/)<br />
IT-Support: [TecBits Web & IT Services](https://www.tecbits.de/)<br />
